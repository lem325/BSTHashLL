...
/**
 * Maximum number of collisions refers to the max amount of times that things in the hashmap will be placed in the
 * same row, resulting in a collision.
 * This gets calculated by the linked list size, and where it is the longest, hence max collisions!
 */
